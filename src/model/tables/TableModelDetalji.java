...
public class TableModelDetalji extends AbstractTableModel{
    ...
    List<Zapisnik> list;
    final String[] columnNames = {"Obrazac", "Datum donosenja", "Datum prijema"};

    public TableModelDetalji() {
        list = new ArrayList<>();
    }

    public TableModelDetalji(List<Zapisnik> list) {
        this.list = list;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                return z.getObrazac();
            case 1:
                return z.getDatumDonosenja();
            case 2:
                return z.getDatumPrijema();
            default:
                return " ";
        }
    }
